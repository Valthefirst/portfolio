  ...
  return (
    <section id="hobbies" className="mt-4 mb-8 md:mb-24">
        ...
        {Object.entries(hobbies).map(([hobby, hobbyInfo]) => {
          ...
          return (
            <div key={hobby} className="bg-white dark:bg-gray-800 shadow-lg rounded-lg overflow-hidden">
              ...
              <div className="p-4">
                <h3 data-translate className="text-xl font-semibold text-gray-900 dark:text-white">{hobby}</h3>
                <p data-translate className="text-sm text-gray-600 dark:text-gray-300">{description}</p>
                {isLoggedIn && (
                  <div className="mt-4">
                    <button
      ...
      {isModifyModalOpen && (
        <div className="fixed inset-0 bg-gray-600 bg-opacity-50 flex justify-center items-center z-50">
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-xl max-w-md w-full space-y-4">
            <h3 data-translate className="text-lg leading-6 font-medium text-gray-900 dark:text-white">Modify Hobby</h3>
            <input
              type="text"
      ...
      {isAddModalOpen && (
        <div className="fixed inset-0 bg-gray-600 bg-opacity-50 flex justify-center items-center z-50">
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-xl max-w-md w-full space-y-4">
            <h3 data-translate className="text-lg leading-6 font-medium text-gray-900 dark:text-white">Add Hobby</h3>
            <input
              type="text"
              className="w-full p-2 border border-gray-300 dark:border-gray-700 rounded bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-white"

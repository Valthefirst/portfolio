    ...
    <section id="about" className="about-section py-12 px-4">
      <div className="container mx-auto flex flex-col md:flex-row gap-8 items-center justify-between">
        <div className="text-gray-800 dark:text-white">
          ...
          <div className="mb-4">
            <h3 data-translate className="text-xl font-semibold mb-2">Education</h3>
            <h3 data-translate className="text-xl font-semibold mb-2">{education}</h3>
            {isLoggedIn && (
              <div className="mt-4">
